...
--
-- Table structure for table `cuentasxusuario`
--

DROP TABLE IF EXISTS `cuentasxusuario`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cuentasxusuario` (
  `cuentas_idcuenta` int(11) NOT NULL,
  `usuarios_dni` int(11) NOT NULL,
  `usuarios_usuario` varchar(45) NOT NULL,
  PRIMARY KEY (`cuentas_idcuenta`,`usuarios_dni`,`usuarios_usuario`),
  KEY `fk_cuentasxusuario_usuarios1_idx` (`usuarios_dni`,`usuarios_usuario`),
  CONSTRAINT `fk_cuentasxusuario_cuentas1` FOREIGN KEY (`cuentas_idcuenta`) REFERENCES `cuentas` (`idcuenta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_cuentasxusuario_usuarios1` FOREIGN KEY (`usuarios_dni`, `usuarios_usuario`) REFERENCES `usuarios` (`dni`, `usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cuentasxusuario`
--

LOCK TABLES `cuentasxusuario` WRITE;
/*!40000 ALTER TABLE `cuentasxusuario` DISABLE KEYS */;
/*!40000 ALTER TABLE `cuentasxusuario` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `movimientosxcuenta` (
  ...
  PRIMARY KEY (`idtransacion`),
  KEY `fk_movimientosxcuenta_cuentas1_idx` (`idcuenta`),
  CONSTRAINT `fk_movimientosxcuenta_cuentas1` FOREIGN KEY (`idcuenta`) REFERENCES `cuentas` (`idcuenta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_movimientosxcuenta_movimientos1` FOREIGN KEY (`idtransacion`) REFERENCES `movimientos` (`idtransacion`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `prestamosxcuenta` (
  ...
  KEY `fk_prestamosxcuenta_prestamos1_idx` (`idprestamo`),
  CONSTRAINT `fk_prestamosxcuenta_cuentas1` FOREIGN KEY (`idcuenta`) REFERENCES `cuentas` (`idcuenta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_prestamosxcuenta_prestamos1` FOREIGN KEY (`idprestamo`) REFERENCES `prestamos` (`idprestamo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-11-09 20:59:38
